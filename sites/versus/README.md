...
45-site registry it remains site index 43 and runs on container port `40043`.

```bash
docker run -e WEBSYN_CONTROL_TOKEN -d --rm --name wh-versus -p 8101:8101 -p 40000-40044:40000-40044 webharbor:dev
